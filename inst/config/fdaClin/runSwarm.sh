...
export CONFIG_FILE=/data/augustin/rPackages/rcellminerElasticNet/inst/config/fdaClin/config.json
export SWATH_OUTPUT=/data/augustin/swathOutput_$DATE
export SWARM_OUTPUT=/data/augustin/swathOutput_$DATE.swarm
#printenv | sort # View variables

# MAKE OUTPUT DIRECTORY
mkdir swathOutput_$DATE
